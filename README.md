...
O aplicativo deve exibir inicialmente uma lista paginada dos repositórios, ordenados por popularidade decrescente (exemplo de chamada da API: `https://api.github.com/search/repositories?q=language:Kotlin&sort=stars&page=1`).
...
![mockup](https://github.com/paulomarne/mobile-challenge/blob/master/mockup-ios.png)
